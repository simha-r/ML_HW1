...
pipeM = Pipeline1([ ('Scale',StandardScaler()),
                   ...
                   ('MLP',MLPClassifier(max_iter=3000,early_stopping=False))])
...
data_clf = basicResults(pipeM,data_train_x,data_train_y,data_test_x,data_test_y,params,'ANN',dataset,scorer='f1')
...
iterationLC(pipeM,data_train_x,data_train_y,data_test_x,data_test_y,{'MLP__max_iter':[2**x for x in range(11)]},'ANN',dataset=dataset,scorer='f1')